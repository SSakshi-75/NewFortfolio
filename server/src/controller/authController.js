...
export const seedAdmin = async () => {
  try {
    ...
    if (!portfolioDoc) {
      ...
      if (!portfolioDoc.projects?.length) { portfolioDoc.projects = defaults.projects; updated = true; }
      if (!portfolioDoc.education?.length) { portfolioDoc.education = defaults.education; updated = true; }
      if (!portfolioDoc.certifications?.length) { portfolioDoc.certifications = defaults.certifications; updated = true; }
      if (!portfolioDoc.codingStats?.length) { portfolioDoc.codingStats = defaults.codingStats; updated = true; }
      if (!portfolioDoc.services?.length) { portfolioDoc.services = defaults.services; updated = true; }
      if (!portfolioDoc.about?.bio) { Object.assign(portfolioDoc.about, defaults.about); portfolioDoc.markModified("about"); updated = true; }
      ...
      if (!portfolioDoc.navbar?.links?.length) { portfolioDoc.navbar.links = defaults.navbar.links; portfolioDoc.markModified("navbar"); updated = true; }
      if (updated) {

    ...
    <div className="space-y-6">
      ...
      <div className="p-5 rounded-2xl bg-white dark:bg-white/[0.02] border border-gray-200 dark:border-white/[0.06] space-y-4">
        <div className="flex items-center justify-between">
          <h3 className="text-gray-900 dark:text-white font-semibold text-sm">Profile Photo (via Cloudonix)</h3>
          {form.profilePhoto && (
            <SaveButton 
              onClick={() => handleSaveField({ profilePhoto: form.profilePhoto }, 'Profile photo URL saved!', 'profilePhoto')} 
              loading={loadingStates.profilePhoto} 
              label="Save Photo URL"
            />
          )}
        </div>
      ...
      <div className="p-5 rounded-2xl bg-white dark:bg-white/[0.02] border border-gray-200 dark:border-white/[0.06] space-y-4">
        <div className="flex items-center justify-between">
          <h3 className="text-gray-900 dark:text-white font-semibold text-sm">Basic Info</h3>
          <SaveButton 
      ...
      <div className="p-5 rounded-2xl bg-white dark:bg-white/[0.02] border border-gray-200 dark:border-white/[0.06] space-y-4">
        <div className="flex items-center justify-between">
          <h3 className="text-gray-900 dark:text-white font-semibold text-sm">Roles / Titles</h3>
          <SaveButton 
            onClick={() => handleSaveField({ roles: form.roles }, 'Roles saved!', 'roles')} 
      ...
      <div className="p-5 rounded-2xl bg-white dark:bg-white/[0.02] border border-gray-200 dark:border-white/[0.06] space-y-4">
        <div className="flex items-center justify-between">
          <h3 className="text-gray-900 dark:text-white font-semibold text-sm">Stats Counter</h3>
          <SaveButton 
            onClick={() => handleSaveField({ stats: form.stats }, 'Stats saved!', 'stats')} 
      ...
      <div className="p-5 rounded-2xl bg-white dark:bg-white/[0.02] border border-gray-200 dark:border-white/[0.06] space-y-4">
        <div className="flex items-center justify-between">
          <h3 className="text-gray-900 dark:text-white font-semibold text-sm">Tech Stack</h3>
          <SaveButton 
            onClick={() => handleSaveField({ techStack: form.techStack }, 'Tech stack saved!', 'techStack')} 
      ...
      <div className="p-5 rounded-2xl bg-white dark:bg-white/[0.02] border border-gray-200 dark:border-white/[0.06] space-y-4">
        <div className="flex items-center justify-between">
          <h3 className="text-gray-900 dark:text-white font-semibold text-sm">Social Links</h3>
          <SaveButton 
            onClick={() => handleSaveField({ socialLinks: form.socialLinks }, 'Social links saved!', 'socialLinks')} 

...
const Resume = () => {
  ...
  const contactInfo = [
    {
      label: 'Email',
      value: contact?.email || hero?.email || 'shivam6386000621@gmail.com',
      href: `mailto:${contact?.email || hero?.email || 'shivam6386000621@gmail.com'}`,
    ...
    {
      label: 'Phone',
      value: contact?.phone || hero?.phone || '+91-6386000621',
      href: `tel:${(contact?.phone || hero?.phone || '+91-6386000621').replace(/\s/g, '')}`,
      icon: (<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" /></svg>),
      color: 'from-emerald-500/20 to-teal-500/20',
    },
    {
      label: 'Location',
      value: contact?.location || 'Gorakhpur, Uttar Pradesh, India',
      href: '#',
  ...
  const isAvailable = contact?.available !== undefined ? contact.available : true;
  const availabilityText = contact?.availabilityText || "I'm currently available for freelance work and full-time opportunities. Let's build something amazing together!";
  ...
  return (
    <section id="resume" className="relative py-24 lg:py-32 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10">
        ...
        {/* Resume CTA - View & Download */}
        <div className="mb-14 p-6 sm:p-8 rounded-2xl bg-gradient-to-r from-blue-500/[0.06] via-cyan-500/[0.04] to-purple-500/[0.06] border border-white/[0.08]">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                ...
                <p className="text-gray-400 text-sm">View or download a detailed overview of my experience</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              {/* View Resume Button */}
              <button
                ...
                className="group relative inline-flex items-center gap-2 px-6 py-3 rounded-full text-gray-900 dark:text-white font-semibold text-sm overflow-hidden transition-all duration-300 hover:scale-105 cursor-pointer"
              >
                <div className="absolute inset-0 rounded-full border border-gray-300 dark:border-white/[0.15] group-hover:border-blue-500/40 transition-colors duration-300" />
                <div className="absolute inset-0 rounded-full bg-gray-50 dark:bg-white/[0.03] group-hover:bg-blue-500/10 transition-colors duration-300" />
              ...
              <button
                onClick={() => { setShowResume(true); setTimeout(() => document.querySelector('[data-download-btn]')?.click(), 300); }}
                className="group relative inline-flex items-center gap-2 px-6 py-3 rounded-full text-gray-900 dark:text-white font-semibold text-sm overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-[0_0_30px_rgba(59,130,246,0.3)] cursor-pointer"
              >
          ...
          <div className="lg:w-7/12">
            <div className="p-6 sm:p-8 rounded-2xl bg-white dark:bg-white/[0.02] border border-white/[0.06]">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="group relative w-full inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-xl text-gray-900 dark:text-white font-semibold text-sm overflow-hidden transition-all duration-300 hover:shadow-[0_0_30px_rgba(59,130,246,0.3)] cursor-pointer"
                >

        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {filteredProjects.map((project) => (
            ...
            >
              ...
              <div 
                className={`h-48 relative flex items-center justify-center bg-cover bg-center overflow-hidden`}
                style={{ 
              ...
              >
                ...
                {/* Hover overlay links */}
                <div className={`absolute inset-0 bg-black/60 backdrop-blur-sm hidden md:flex items-center justify-center gap-3 transition-opacity duration-300 z-20 ${hoveredId === project.id ? 'opacity-100' : 'opacity-0'}`}>
                  <a href={project.github} target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-lg bg-white/10 border border-white/20 flex items-center justify-center text-white hover:bg-white/20 transition-colors duration-200 cursor-pointer" title="GitHub">
                  ...
                  <a href={project.live} target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-lg bg-white/10 border border-white/20 flex items-center justify-center text-white hover:bg-white/20 transition-colors duration-200 cursor-pointer" title="Live Demo">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg>
                  </a>
                  <button onClick={() => navigate(`/project/${project.id}`)} className="w-9 h-9 rounded-lg bg-white/10 border border-white/20 flex items-center justify-center text-white hover:bg-blue-500/40 hover:border-blue-400/50 transition-all duration-200 cursor-pointer" title="More Details">
